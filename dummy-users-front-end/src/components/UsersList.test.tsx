...
describe("UsersList", () => {
  it("displays a list of users", async () => {
    ...
    (axios.get as vi.MockedFunction<typeof axios.get>).mockResolvedValueOnce({ data: mockUsers });
  ...
  it("displays loading state initially", () => {
    ...
    (axios.get as vi.MockedFunction<typeof axios.get>).mockResolvedValueOnce({ data: { users: mockUsers } });
  ...
  it("handles API error", async () => {
    ...
    (axios.get as vi.MockedFunction<typeof axios.get>).mockRejectedValueOnce(new Error("Failed to fetch users"));
